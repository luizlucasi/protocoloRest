    ...
    <div>
      ...
      <div className="table-responsive">
        {usuarioList && usuarioList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('nomeUsuario')}>
                  Nome Usuario <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isActive')}>
                  Is Active <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  Tipo Usuario <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {usuarioList.map((usuario, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{usuario.isActive ? 'true' : 'false'}</td>
                  <td>{usuario.tipoUsuario ? <Link to={`tipo-usuario/${usuario.tipoUsuario.id}`}>{usuario.tipoUsuario.id}</Link> : ''}</td>
          ...
          <div className="alert alert-warning">No Usuarios found</div>
        )}
      </div>
